# aws-dynamodb-es-cqrs · ES/CQRS using AWS DynamoDB [![npm version](https://img.shields.io/npm/v/@coderbyheart/aws-dynamodb-es-cqrs.svg)](https://www.npmjs.com/package/@coderbyheart/aws-dynamodb-es-cqrs)
